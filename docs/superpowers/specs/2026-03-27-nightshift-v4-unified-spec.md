# NightShift V4.1 Unified Spec

**Date:** 2026-03-27

**Status:** Unified product and kernel specification, revised to close key interface and lifecycle gaps discovered during design review. Supersedes V4 as the primary design target while preserving V1, V2, and V3 as earlier design iterations.
...
8. Accept, reject, retry, or suspend.
...
V4.1 additionally closes four structural gaps that were too underspecified in V4:

- engine adapter error contracts
- `blocked` versus `deferred` queue semantics
- repository context acquisition strategy for requirement splitting
- explicit alerting semantics for unattended overnight runs
